...
void bace(void){
	...
	leftleg_strech(60,60,60,30);
	rightleg_strech(60,60,60,30);
	kosi_strech(20);
...
void side_wolk_R(void){
	...
	leftleg_strech(60,60,60,60);
	rightleg_strech(60,60,60,60);
	leftleg_speed(127,127,127,60);
	rightleg_speed(127,127,127,60);
	leftarm(-30,60,0);
	rightarm(-30,60,0);
	kosi_strech(60);
...
void syagami(void){
	...
	if(i==1){
		leftleg(50,360,360,-55);
		rightleg(50,360,360,-55);
		leftarm(-60,360,0);
		rightarm(-60,360,0);
	}
	if(CONTLLOR()!=C_PEC){
...
void stand_flont(void){
	...
	if(cnt_time>1500){
		leftleg(50,80,-80,-45);
		rightleg(50,80,-80,-45);
		leftarm(0,40,80);
		rightarm(0,40,80);
	}else if(cnt_time>1000){
		leftleg(50,90,-90,-45);
		rightleg(50,90,-90,-45);
		leftarm(-90,40,80);
		rightarm(-90,40,80);
	}else if(cnt_time>500){
		leftleg(50,90,-90,-45);
...
void up_flont(void){
	rightarm_speed(127,127,127);
	leftarm_speed(127,127,127);
	leftarm_strech(60,60,30);
	rightarm_strech(60,60,30);
	leftleg_strech(60,60,60,60);
	rightleg_strech(60,60,60,60);
	kosi_strech(60);
	rightleg(20,40,-40,-25);
	leftleg(20,40,-40,-25);
	kosi(0);
	if(cnt_time >2300){
		leftarm(-80,360,0);
